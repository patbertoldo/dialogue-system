...
namespace Dialogue
{
    ...
    public class DialogueContainer : MonoBehaviour
    {
        ...
        public DialogueContainerLayout LayoutLeft => layoutLeft;
        public DialogueContainerLayout LayoutRight => layoutRight;
        public CanvasGroup CanvasGroup => canvasGroup;
        public AudioSource AudioSource => audioSource;
        public GameObject CompletedGO => completedGO;
        
        private Image portrait;
        private TMP_Text descriptionText;
        
        public Image Portait => portrait;
        ...
        public async UniTask PlayUnfocus(Vector3 position)
        {
        ...
        public async UniTask PlayFinished(bool forceOff = false)
        {
            dialogueContainerState = DialogueContainerState.OFF;
            
            await canvasGroup.DOFade(0, fadeTime).OnComplete(() => completedGO.SetActive(false));
        }
        ...
        public async UniTask ShowEffectAsync()
        {
            hidden = false;
        ...
        public async UniTask HideEffectAsync()
        {
            hidden = true;
        ...
        public async UniTask ShakeEffectAsync()
        {
            if (isShaking)
                return;
            
            isShaking = true;
            await transform.DOShakePosition(shakeTime, shakeStrength, shakeVibrato)
                .OnComplete(() =>
                {
                    isShaking = false;
                });
        ...
        public async UniTask EmotionEffectAsync(DialogueBlock dialogueBlock, Emotions emotion)
        {
            portrait.sprite = dialogueBlock.DialogueCharacter.GetPortrait(emotion);
            audioSource.clip = dialogueBlock.DialogueCharacter.GetAudioClip(emotion);
